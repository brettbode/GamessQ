...
////@begin AboutGamessQ content construction
    ...
    wxStaticText* itemStaticText3 = new wxStaticText( itemDialog1, wxID_STATIC, _("GamessQ 1.2"), wxDefaultPosition, wxDefaultSize, 0 );
